                ...
                welcome_buttons = {
                    "inline_keyboard": [
                        ...
                        [{"text": "🔄 Try Again", "url": f"https://t.me/your_bot_username?start=retry"}]
                                ...
                                welcome_text =""✨ 𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝖬𝗈𝗏𝗂𝖾𝖡𝗈𝗍  💖\n\nမင်္ဂလာပါရှင်... ရုပ်ရှင်ချစ်ပရိသတ်တို့ရေ 🎬🍿\n\nရုပ်ရှင်အသစ်စက်စက်လေးတွေနဲ့ Movie Link တွေကိုဒီမှာ\n\nအမြဲတင်ပေးသွားမှာမို့လို့ စောင့်မျှော်ပေးကြပါဦးနော် 🥰✨\n\n**လင့်ခ်တွေကို အမြန်ဆုံးသိရအောင် အောက်က**\n\n𝖩𝗈𝗂𝗇 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 ကိုနှိပ်ပြီး\n\nChannel ထဲဝင်ထားပေးပါဦးရှင်...\n\n ချစ်မွတ်စ် 💋👉👈""
